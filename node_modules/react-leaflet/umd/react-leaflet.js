(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactLeaflet = {}, global.React, global.ReactDOM, global.L));
}(this, (function (exports, React, reactDom, leaflet) { 'use strict';
  ...
  function removeClassName(element, className) {
    splitClassName(className).forEach(cls => {
      leaflet.DomUtil.removeClass(element, cls);
    });
  }
  ...
  function Pane(props) {
    const context = useLeafletContext();
    const paneElementRef = React.useRef(null);
    const propsRef = React.useRef(props);
    ...
    React.useEffect(function handlePane() {
